    ...
    blocks: [
      {
        ...
        title: "메인화면 - 첫번째",
        text: "-물리치료사로서의 경험을 바탕으로,환자와 일반인 모두가 근육·관절 구조를 3D로 직관적으로 이해할 수 있도록 제작했습니다. \n단순한 모형이 아니라, 부위별 클릭 → 설명 연동이 가능하게 설계했습니다.",
        links: [
      ...
      },
      {
        ...
        title: "메인화면 - 두번째",
        text: "\n- Three.js + GLTFLoader: 인체 모델 로딩 및 파트별 식별\n- Raycaster: 클릭 시 해당 부위의 이름/정보 감지\n- OrbitControls: 확대·회전·이동 제어 (UX 향상)\n- 커스텀 UI(±, 리셋) 로 사용자가 쉽게 조작 가능하게 구현\n- 콘솔 로그 기반 디버깅으로 각 이벤트 상태를 추적",
      },
      {
        media: [{ src: imgPhysiclick }],
        title: "유튜브 연동 게시글 화면",
        text: "유튜브 api 연동, 클릭 부위별 게시글과 쿼리기반 영상 노출",
      },
      {
        media: [{ src: main_1 }],
        title: "css 크롭 기능으로 경량화",
        text: "부위별 클릭 요소",
      },
      {
        media: [{ src: main_2 }],
        title: "카카오 api",
        text: "가까운 병원 찾기 기능 구현",
      },
    ],
  },
  {
